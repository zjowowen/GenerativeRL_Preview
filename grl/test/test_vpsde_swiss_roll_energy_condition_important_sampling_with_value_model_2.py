...
config = EasyDict(
    ...
    parameter=dict(
        ...
        evaluation=dict(
            eval_freq=5000,
            video_save_path="./video-swiss-roll-diffusion-model-important-sampling-with-value-model-2",
            model_save_path="./model-swiss-roll-diffusion-model-important-sampling-with-value-model-2",
        ),
    ),
)
...
if __name__ == "__main__":
    ...
    for train_iter in track(
        ...
        diffusion_model_importance_sampling_training_loss = torch.mean(
            diffusion_model_importance_sampling_training_loss
            * torch.exp(value - fake_value_softmax)
        )
